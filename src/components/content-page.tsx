...
function Info({ icon: Icon, title, text }: { icon: typeof HelpCircle; title: string; text: string }) { return <div className="flex gap-4 rounded-2xl border bg-card p-5"><div className="flex h-11 w-11 items-center justify-center rounded-xl bg-primary/10 text-primary"><Icon /></div><div><p className="font-semibold">{title}</p><p className="text-muted-foreground">{text}</p></div></div>; }